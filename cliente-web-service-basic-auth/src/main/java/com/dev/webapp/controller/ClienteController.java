...
public class ClienteController {
	...
	@DeleteMapping(value = "/elimina/codFid/{codFid}")
	public ResponseEntity<Mono<Void>> deleteClienteByCodFid(@PathVariable(value = "codFid") String codFid) {
		Mono<Void> monoDeleted = clienteService.deleteByCodFid(codFid);
		return new ResponseEntity<Mono<Void>>(monoDeleted, HttpStatus.OK);
	}
}